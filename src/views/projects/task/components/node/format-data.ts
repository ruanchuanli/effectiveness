...
export function formatParams(data: INodeData): {
  ...
  const params = {
    ...
    taskDefinitionJsonObj: {
      ...
      dataDesc: data.dataDesc || undefined,
      dataDescInventory: data.dataDescInventory || undefined,
      indicatorType: data.indicatorType || undefined,
      dataRequirements: data.dataRequirements || undefined,
