...
import { getAssessmentTaskById, getUnboundInputDataSubProcess } from '@/service/modules/assessmentTask'
...
export default defineComponent({
  ...
  setup() {
    ...
    const projectCode = Number(route.params.id)
    ...
    getAssessmentTaskById(projectCode).then((res: any) => {
