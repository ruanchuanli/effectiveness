...
import { NSpin, NDescriptions, NDescriptionsItem } from 'naive-ui';
...
const XiangQing = defineComponent({
    ...
    render() {
        const { show, id, t, detailForm, rules, loading, saving, onCancel, onSubmit, beforeUpload, showShuoMing, openShuoMing, columns, dowmLoadJiaoBen } = this, onCreate = () => {
            return {
                paramName: '',
                paramDes: '',
                selectValue: null,
        ...
        return (<Modal style="width: 60%" class='dialog-create-data-source' show={show} title={'查看'} onConfirm={onCancel} confirmLoading={saving || loading} onCancel={onCancel} confirmClassName='btn-submit' cancelClassName='btn-cancel'>
                ...
                default: () => (<NSpin show={loading}>
                            <NDescriptions label-placement="left" column={1}>
                                ...
                                {/*        columns*/}
                                {/*      }*/}
                                {/*      data={detailForm.inputParamsList}*/}
                                {/*  />*/}
                                {/*</NDescriptionsItem>*/}
                                ...
                                {/*        columns*/}
                                {/*      }*/}
                                {/*      data={detailForm.outputParamsList}*/}
                                {/*  />*/}
                                {/*</NDescriptionsItem>*/}
                            </NDescriptions>
                        </NSpin>)
