...
import {useTable} from "@/views/operator-management/custom-operator/use-table";
...
const EditModal = defineComponent({
  ...
  setup(props, ctx) {
    ...
    const { status, queryById, createOrUpdate,downloadFile } =
    ...
    const dowmLoadJiaoBen = () => {
      downloadFile(props.id as number, state.detailForm.fileName)
    }
                ...
                <NSpin show={loading}>
                  ...
                  >
                    ...
                    <NFormItem label='输入参数'>
                      <NDynamicInput
                          on-create={onCreate}
                          v-model={[detailForm.inputParamsList, 'value']}
                      >
                        {
                            ({ value: formData }:any) => {
                              return (
                    ...
                    <NFormItem label='输出参数'>
                      <NDynamicInput
                          on-create={onCreate}
                          v-model={[detailForm.outputParamsList, 'value']}
                      >
                        {
                          ({ value: formData }:any) => {
                            return (
                    ...
                    <NFormItem label='参数配置'>
                      <NDynamicInput
                        on-create={onCreate}
                        v-model={[detailForm.paramsConfigList, 'value']}
                      >
                        {
                          ({ value: formData }:any) => {
                            return (
