...
} from '@/service/modules/custom-operator'
...
import type {
  ResultItem,
  ResultListRes
} from '@/service/modules/custom-operator/types'
...
import AccessibilitySupport = editor.AccessibilitySupport
import { useDetail } from '@/views/operator-management/custom-operator/use-detail'
