...
import { ITask } from '../../instance/gantt/type'
import { ITaskData } from '@/views/projects/task/definition/types'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const enterComputeProcess = () => {
      console.log(route)
      console.log(props.cell)
      console.log(props.taskInstance)

      const projectCode = Number(route.params.projectCode)
      const processDefinitionCode = JSON.parse(
        props.taskInstance?.taskParams
    ...
    const isLeftNode = computed(() => {
      return props.taskInstance?.taskType == 'SUB_PROCESS'
    })
    ...
    return (
      this.visible && (
        ...
        >
          ...
          {this.taskInstance && !this.isLeftNode && (
            <NButton
              class={`${styles['menu-item']}`}
          ...
          {this.taskInstance && this.isLeftNode && (
            <NButton
              class={`${styles['menu-item']}`}
              onClick={this.enterComputeProcess}
            >
              进入计算流程
            </NButton>
          )}
