...
import { useMessage, NTabs, NTabPane, NTable } from 'naive-ui'
    ...
    return () => (
      <div class={styles.withConent}>
        <div class={styles.top}>
          <div class={styles.labelTitle}>算子信息</div>
          ...
          <NTabs type='line' animated>
            <NTabPane name='输入参数' tab='输入参数'>
              <NTable>
                ...
                <tbody>
                  {props.labelData.inputParamsList ? (
                    props.labelData.inputParamsList.map(
                      (item: any, index: any) => {
                        return (
            ...
            <NTabPane name='输出参数' tab='输出参数'>
              <NTable>
                ...
                <tbody>
                  {props.labelData.outputParamsList ? (
                    props.labelData.outputParamsList.map(
                      (item: any, index: any) => {
                        return (
                          <tr data-index={index} style={'text-align: center;'}>
                            <td>{item.paramName ? item.paramName : '--'}</td>
