...
import { savePic } from '@/service/modules/assessmentPlan'
const props = {
  ...
  setup(props, context) {
    ...
    function SaveNode(){
      let saveForm = {
        ...
        release: true,
        sync: false,
        targetTaskDefinitionCode:route.params.taskcode
      }
          ...
          graph.value?.toPNG((dataUri: string) => {
            ...
            let taskDefinitionCode = route.params.taskcode as string
            savePic(taskDefinitionCode, file)
          })
    ...
    return () => (
      ...
      >
        ...
        <div class={Styles.content}>
          ...
          <RightWeight labelData={labelObj.value} />
        </div>
        <DagAutoLayoutModal
