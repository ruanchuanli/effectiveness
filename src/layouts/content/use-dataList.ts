...
export function useDataList() {
  ...
  const changeMenuOption = (state: any) => {
    ...
    state.menuOptions = [
      ...
      {
        label: () =>
          h(NEllipsis, null, { default: () => t('menu.assessment') }),
        key: 'assessment',
        icon: renderIcon(HomeOutlined)
      },
      {
        ...
        children: [
          {
            label: '费用模型',
            key: '/evaluation-model/cost-management',
            icon: renderIcon(PartitionOutlined)
          },
          {
            label: '指标选取',
            key: '/evaluation-model/indicator-selection',
            icon: renderIcon(ApartmentOutlined)
          },
          {
            label: '效能评估模型',
            key: '/evaluation-model/effectiveness-evaluation-model',
            icon: renderIcon(ApartmentOutlined)
          }
        ]
      },
      ...
      {
        label: () =>
          h(NEllipsis, null, { default: () => t('menu.theme_data') }),
        key: 'theme-data',
        icon: renderIcon(ProjectOutlined),
        children: [
          {
            label: '装备目录',
            key: '/theme-data/equipment-dir',
            icon: renderIcon(PartitionOutlined)
          },
          {
            label: '分系统目录',
      ...
      {
        label: () =>
          h(NEllipsis, null, { default: () => t('menu.operator_management') }),
        key: 'operator-management',
        icon: renderIcon(ContainerOutlined),
        children: [
          {
            label: t('menu.custom_operator'),
            key: '/operator-management/custom-operator',
            icon: renderIcon(ApartmentOutlined)
          },
          {
            label: t('menu.default_operator'),
            key: '/operator-management/default-operator',
            icon: renderIcon(ApartmentOutlined)
          }
        ]
      },
