...
import assessmentPlan from './modules/assessmentPlan'
...
import operatorManagement from './modules/operator-management'
import assessmentTask from './modules/assessmentTask'
import assessmentTaskInstance from './modules/assessmentTaskInstance'
import evaluationModel from './modules/evaluation-model'
import themeData from './modules/theme-data'
